...
export const Card = styled.div`
   ...
   // max-width: 180px;      /* prevents ultra-wide cards on tablets */
    ...
    &:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,.10); }
...
export const ToolIcon = styled.div`
  ...
  svg { width: 20px; height: 20px; color: #0a0a0a; }
`;
...
export const ToolCTA = styled.button`
  ...
  &:hover { background: #1ed760; transform: translateY(-1px); }
  &:active { transform: translateY(0); }
`;
